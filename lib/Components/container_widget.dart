...
class CustomCard extends StatelessWidget {
  CustomCard({required this.imageName, required this.title, required this.price, required this.description});
...
class CustomMenuCard extends StatelessWidget {
  CustomMenuCard({required this.imageName, required this.title, required this.price, required this.description});
